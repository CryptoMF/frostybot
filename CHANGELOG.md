...
<li>added support for the triggertype parameter to specify which price to use for stop loss orders, valid values are mark, index and last. For example: deribit:long size=10000 stoptrigger=-200 triggertype=last</li>
